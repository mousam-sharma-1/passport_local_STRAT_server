...
@Component({
  selector: 'app-retailer-transaction',
  templateUrl: './retailer-transaction.component.html',
  styleUrls: ['./retailer-transaction.component.scss']
})
export class RetailerTransactionComponent implements OnInit {
